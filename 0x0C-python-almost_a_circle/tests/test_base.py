...
class TestBase(unittest.TestCase):
    ...
    def test_to_json_string(self):
        ...
        self.assertCountEqual(
            Base.to_json_string(o1_1), '[{"hi": 1, "yo": "hol"}]'
        )
    ...
    def test_save_to_file(self):
        ...
        self._extracted_from_test_load_from_file_4()
    ...
    # TODO Rename this here and in `test_save_to_file` and `test_load_from_file`
    def _extracted_from_test_load_from_file_4(self):
