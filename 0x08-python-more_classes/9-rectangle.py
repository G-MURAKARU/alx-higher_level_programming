...
class Rectangle:
    ...
    @classmethod  # used usually as alternative constructors
    def square(cls, size: int = 0):
        """
        square returns a square from a rectangle

        Args:
            size (int, optional): sides of the square. Defaults to 0.

        Returns:
            Rectangle: a Rectangle with width == height
        """
